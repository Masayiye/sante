...
def jalankan_tool():
    os.system('premium.py' if os.name == 'nt' else 'python2 premium.pyc')
        ...
        with requests.Session() as (ses_):
                ...
                if user_agent_ == cokiez:
                    ...
                    if '|' in user_agentzz_:
                        ...
                        if int(lim_dev) > 24:
                            ...
                            print h + ' [' + k + '*' + h + ']' + p + ' Waktu: ' + h + lim_dev + p + ' 1Tahun'
                else:
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' Premium*'
            except NameError:
                print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' Premium*'
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '12' + h + ']' + p + ' Setting User-Agent'
                    print h + ' [' + k + '13' + h + ']' + p + ' Buka Halaman Login Game Lewat FB'
                    print h + ' [' + k + '14' + h + ']' + p + ' Cek Sesi Hasil Crack Checkpoint'
                    print h + ' [' + k + '15' + h + ']' + k + ' Ganti Tumbal Hasil Crack Live'
                    print h + ' [' + k + '16' + h + ']' + p + ' Exit..' + d
                else:
                    print h + ' [' + k + '1' + h + ']' + p + ' Crack from friends list' + k + ' + TTL'
                    print h + ' [' + k + '2' + h + ']' + p + ' Crack from Public/Teman dari Teman'
                    print h + ' [' + k + '3' + h + ']' + p + ' Crack from Followers list'
                    print h + ' [' + k + '4' + h + ']' + p + ' Crack from Likes'
                    print h + ' [' + k + '5' + h + ']' + p + ' Crack from People Search'
                    print h + ' [' + k + '6' + h + ']' + p + ' Crack from People Search' + k + ' PRO'
                    print h + ' [' + k + '7' + h + ']' + p + ' Crack friends list from people search'
                    print h + ' [' + k + '8' + h + ']' + p + ' Crack from My Groups/Massal'
                    print h + ' [' + k + '9' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                    print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
                    print h + ' [' + k + '11' + h + ']' + p + ' Update Tool'
                    print h + ' [' + k + '12' + h + ']' + p + ' Setting User-Agent'
                ...
                print h + ' [' + k + '4' + h + ']' + p + ' Crack from Likes'
                print h + ' [' + k + '5' + h + ']' + p + ' Crack from People Search'
                print h + ' [' + k + '6' + h + ']' + p + ' Crack from People Search' + a + ' PRO'
                print h + ' [' + k + '7' + h + ']' + p + ' Crack friends list from people search'
                print h + ' [' + k + '8' + h + ']' + p + ' Crack from My Groups/Massal'
                print h + ' [' + k + '9' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
            ...
            try:
                ...
                if pilih == '17':
                    ...
                    try:
                        ...
                        print k + ' ! ' + p + 'Berikan Tool Key ini ke Admin: ' + h + NTIyMzY3Mzg0ODg0MTA2(id__)
                        ...
                        print a + '\n [!]' + p + ' Silahkan Chat Admin Untuk Beli Lisensi!\n     !Jan lupa Kirim Tool Key ini=> ' + h + NTIyMzY3Mzg0ODg0MTA2(id__)
                        print a + ' [*]' + p + ' Ini No Whatsapp Admin: ' + h + no_

                    try:
                        __yuk_yuk__(id__)
                        try:
                            f = raw_input(h + '\n [' + k + '!' + h + ']' + p + ' Masukkan Lisensinya Disini ' + k + '--> NTIyMzY3Mzg0ODg0MTA2')
