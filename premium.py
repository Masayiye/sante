...
def login():
    ...
    try:
        ...
        print h + ' [' + p + '5' + h + ']' + p + ' Cara ambil Cookie FB'
        try:
            if user_agent_ == cokiez:
                ...
                print k + ' [5]' + p + ' Crack Dari Pencarian(No login)[Premium!]'
                print k + ' [7]' + p + ' Cek Hasil Crack Checkpoint'
                print k + ' [8]' + p + ' Ganti Tumbal Hasil Crack Live'
        except:
            print k + ' [6]' + p + ' Crack Dari Pencarian(No login)[Premium!]'
            print k + ' [7]' + p + ' Cek Hasil Crack Checkpoint'
            print k + ' [8]' + p + ' Ganti Tumbal Hasil Crack Live'
        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '6' + h + ']' + p + ' Crack from People Search' + p + ' (' + a + 'PRO' + p + ')'
                    ...
                    print h + ' [' + k + '2' + h + ']' + l + ' Crack from Public/Teman dari Teman'
                    print h + ' [' + k + '3' + h + ']' + p + ' Crack from Followers list'
                    print h + ' [' + k + '4' + h + ']' + p + ' Crack from Likes'
                    print h + ' [' + k + '5' + h + ']' + p + ' Crack from People Search'
